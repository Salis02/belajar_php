    ...
    <div class="container">
        ...
        <form action="" method="post">
            <div class="row justify-content-between">
                <div class="col-10">
                    <input type="text" name="keyword" class="form-control mb-3" autofocus placeholder="Masukkan data yang akan dicari" autocomplete="off" id="keyword" >
                </div>
                <div class="col-2">
                    <!-- <button type="submit" name="cari" class="btn btn-outline-info" id="cari" >Cari Data</button> -->
                </div>
            </div>
        </form>
